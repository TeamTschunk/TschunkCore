...
class Polygon(Base):
    ...
    def __init__(
        ...
        self.v2 = [(i[0] - self.rect.x, i[1] - self.rect.y)
                   for i in v]  # relative polygon
...
class LineRel(Base):
    ...
    def __init__(
        self, x, y, a=(
            0, 0), b=(
            0, 0), z=0, color=(
                0, 0, 0, 1), stroke=0, rotation=0.0, style=0):
...
class Rect(object):
    ...
    def setQuad(self, q):  # [ q[0][0], q[0][1], q[1][0], q[2][1] ] # l t r b
        self.rect = q[0][0] + (q[1][0] - q[0][0]) * 0.5, q[0][1] + \
            (q[2][1] - q[0][1]) * 0.5, q[1][0] - q[0][0], q[2][1] - q[0][1]

    def getQuad(self):
        return [(self.rect[0], self.rect[1]), (self.rect[2], self.rect[1]), (self.rect[
            2], self.rect[3]), (self.rect[0], self.rect[3])]  # tl tr br bl
...
if __name__ == "__main__":
    ...
    a = Arc(
        ...
        sweep=90,
        style=GLU_FILL)
    P = Polygon([(0, 0), (50, 200), (80, 200), (60, 100),
                 (100, 5)], color=(.3, 0.2, 0.5, .7))
